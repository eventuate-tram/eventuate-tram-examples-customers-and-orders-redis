  ...
  private void waitForConnection() {
    while (true) {
      ...
      try {
        ...
        String datasourceUrl = getenv("SPRING_DATASOURCE_URL", () -> {
          String host = getenv("DOCKER_HOST_IP", () -> "localhost");

          return String.format("jdbc:mysql://%s/eventuate?useSSL=true", host);
        });
