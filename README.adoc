...
1. If you want to run the tests, you need to set `DOCKER_HOST_IP` before running Docker Compose.
...
* `Customer Service` - `http://${DOCKER_HOST_IP}:8081/swagger-ui.html`
* `Order Service` - `http://${DOCKER_HOST_IP}:8082/swagger-ui.html`
* `Order History Service` - `http://${DOCKER_HOST_IP}:8083/swagger-ui.html`
